    ...
    public class TagInfo
    {
        ...
        public string PseudoValue
        {
            get
            {
                ...
                {
                    if (this.tagType == typeof(string)) return "string_value";
                    if (this.tagType == typeof(int)) return "int_value";
                    if (this.tagType == typeof(float)) return "float_value";
                    if (this.tagType == typeof(double)) return "double_value";
                    if (this.tagType == typeof(bool)) return "true_or_false";
                    if (this.tagType.IsEnum) return "enum_value"; //$"{this.tagType.Name}_value";
                    if (this.tagType == typeof(Type)) return "class_name";
                    if (this.tagType.IsSubclassOf(Helper.ClassDef)) return $"{this.tagType.Name}_defName";
                }
                return "value";
            }
        }
        ...
        public IEnumerable<XNode> ToXNodes()
        {
            switch (this.tagCategory)
            {
                ...
                case TagCategory.Dict:
                    ...
                    if (this.description != null) yield return new XComment($"Desc: {this.description}");
                    if (this.Alias != null) yield return new XComment($"Alias: {this.alias}");
                    XElement tag = new XElement(this.tagName);
                    if (this.className != null) tag.SetAttributeValue("Class", this.className);
                    if (this.HasTags)
                    {
                ...
                case TagCategory.Enum:
                    if (this.typeName != null) yield return new XComment($"Type: {this.typeName}");
                    if (this.availableValues != null) yield return new XComment($"Available Values: {this.availableValues}");
                    if (this.defaultValueAsString != null) yield return new XComment($"Default Value: {this.defaultValueAsString}");
                    if (this.description != null) yield return new XComment($"Desc: {this.description}");
                    if (this.Alias != null) yield return new XComment($"Alias: {this.alias}");
